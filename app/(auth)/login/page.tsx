...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // Simple OAuth call - same as working HTML test
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
            <div className="w-32 h-32 bg-white/20 rounded-xl mb-4 flex items-center justify-center">
              <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24" suppressHydrationWarning>
                <path d="M19 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-6 16h-2v-2h2v2zm0-4h-2V6h2v8z"/>
              </svg>
            </div>
            <p className="text-white text-sm">
              Temukan rumah impian Anda dengan mudah dan aman di Holanu.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Masuk ke Holanu</h2>
              <p className="text-gray-600">Marketplace Properti Modern Indonesia</p>
            </div>
            ...
            <div className="mt-6">
              ...
              <button
                ...
                disabled={loading}
                className="mt-4 w-full bg-white hover:bg-gray-50 disabled:bg-gray-100 border border-gray-300 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center"
              >
              ...
              <button
                ...
                className="mt-2 w-full bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-xl transition-all duration-200"
              >
